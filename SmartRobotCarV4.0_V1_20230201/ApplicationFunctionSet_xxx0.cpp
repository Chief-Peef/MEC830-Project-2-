...
void ApplicationFunctionSet::ApplicationFunctionSet_Tracking(void)
{
  ...
  if (Application_SmartRobotCarxxx0.Functional_Mode == TraceBased_mode)
  {
    ...
    while(currentangle <= -92 || currentangle >= -88)
      {
        mpu6050.update();
        delay_xxx(5);
        currentangle = mpu6050.getAngleZ();
        if (currentangle < -92)
        {
          ApplicationFunctionSet_SmartRobotCarMotionControl(Left, 85);
          delay_xxx(25);
        }
        mpu6050.update();
        delay_xxx(5);
        ...
        if (currentangle > -88)
        {
          ApplicationFunctionSet_SmartRobotCarMotionControl(Right, 85);
          delay_xxx(25);
        }
        mpu6050.update();
        delay_xxx(5);
...
void ApplicationFunctionSet::ApplicationFunctionSet_Obstacle(void)
{
  ...
  if (Application_SmartRobotCarxxx0.Functional_Mode == ObstacleAvoidance_mode)
  {
    ...
    ApplicationFunctionSet_SmartRobotCarMotionControl(Forward, 125);
    AppULTRASONIC.DeviceDriverSet_ULTRASONIC_Get(&get_Distance /*out*/);
    ...
    if (function_xxx(get_Distance, 0, 25))
    {
      ...
      currentangle = mpu6050.getAngleZ();
      Serial.println(currentangle);
      while(currentangle <= 75 || currentangle >= 82)
      {
        if (currentangle < 75)
        {
          ApplicationFunctionSet_SmartRobotCarMotionControl(Left, 95);
          delay_xxx(25);
        }
        mpu6050.update();
        delay_xxx(5);
        ...
        if (currentangle > 82)
        {
          ApplicationFunctionSet_SmartRobotCarMotionControl(Right, 95);
          delay_xxx(25);
        }
        mpu6050.update();
        delay_xxx(5);
      ...
      mpu6050.update();
        delay_xxx(5);
        currentangle = mpu6050.getAngleZ();
    ApplicationFunctionSet_SmartRobotCarMotionControl(Forward, 90);
    delay_xxx(2000);
    mpu6050.update();
        delay_xxx(5);
        currentangle = mpu6050.getAngleZ();
    ...
    while(currentangle >= -55 || currentangle <= -62)
      {
        if (currentangle > -55)
        {
          ApplicationFunctionSet_SmartRobotCarMotionControl(Right, 95);
    ...
    ApplicationFunctionSet_SmartRobotCarMotionControl(stop_it, 0);
    delay_xxx(500);
    while(currentangle >= 14 || currentangle <= 10)
      {
        if (currentangle > 14)
        {
          ApplicationFunctionSet_SmartRobotCarMotionControl(Right, 95);
...
void s_until_angle(int anglelow, int anglehigh)
    {
    uint16_t get_Distance;
    int currentangle;
    mpu6050.update();
    ...
    while(currentangle <= anglehigh || currentangle >= anglelow)
      {
        mpu6050.update();
        delay_xxx(5);
        currentangle = mpu6050.getAngleZ();
...
void ApplicationFunctionSet::ApplicationFunctionSet_Follow(void)
{
  ...
  {
    s_until_angle(-89, -91);
    s_until_angle(-176, -179);
    s_until_angle(-260, -264);
    s_until_angle(-350, -354);
    ApplicationFunctionSet_SmartRobotCarMotionControl(stop_it, 0);
    delay_xxx(5000);
  }
}
